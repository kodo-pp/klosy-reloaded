...
struct ustar_file* ustar_fileseek(UNUSED void* tarball, UNUSED size_t max_size, UNUSED const char* filename)
{
    panic("unimplemented function call: ustar_fileseek");
    return nullptr;
}
size_t ustar_read(UNUSED struct ustar_file* file, UNUSED void* buf, UNUSED size_t offset, UNUSED size_t length)
{
    panic("unimplemented function call: ustar_read");
    return 0;
}
